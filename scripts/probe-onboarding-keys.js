...
async function main() {
  ...
  const cmd = `grep -nE 'LLM|OPENAI|GROK|XAI|ANTHROPIC|ONBOARDING|provider' ${root}/Back-end/.secret.example | head -40; echo '---'; grep -rn 'onboarding-agent/status\\|getStatus\\|enabled' ${root}/Back-end/services/llm ${root}/Back-end/routes 2>/dev/null | head -20`;
  try {
